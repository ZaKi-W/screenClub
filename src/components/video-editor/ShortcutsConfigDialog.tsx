			...
			<DialogContent className="bg-[#09090b] border-white/10 text-white max-w-[420px] max-h-[85vh] flex flex-col">
				<DialogHeader className="shrink-0">
					<DialogTitle className="flex items-center gap-2 text-sm">
						<Keyboard className="w-4 h-4 text-[#27E0C1]" />
						{t("title")}
					</DialogTitle>
				</DialogHeader>
									...
									<div className="flex items-center justify-between py-1.5 px-1 border-b border-white/5">
										...
										<button
											...
											className={[
												...
												isCapturing
													? "bg-[#27E0C1]/20 border-[#27E0C1] text-[#27E0C1] animate-pulse"
													: hasConflict
														? "bg-amber-500/10 border-amber-500/50 text-amber-400"
														: "bg-white/5 border-white/10 text-slate-200 hover:border-[#27E0C1]/50 hover:text-[#27E0C1] cursor-pointer",
											].join(" ")}
										>
				...
				<DialogFooter className="shrink-0 flex gap-2 sm:justify-between mt-2">
					...
					<div className="flex gap-2">
						...
						<Button
							size="sm"
							className="bg-[#27E0C1] hover:bg-[#8AF7E3] text-[#001B16]"
							onClick={handleSave}
						>
							{tc("actions.save")}
						</Button>
