...
export interface SceneEffects {
	...
	/** 0..1 legacy aggregate screen motion blur. */
	motionBlur: number;
	/** 0..1 blur generated by screen zooming. */
	motionBlurZoom: number;
	/** 0..1 blur generated by screen panning. */
	motionBlurPan: number;
	/** Global zoom/pan camera response. */
...
export function buildSceneDescription(
	...
	return {
		...
		effects: {
			...
			motionBlurZoom: settings.motionBlurZoom,
			motionBlurPan: settings.motionBlurPan,
			screenAnimationStyle: settings.screenAnimationStyle,
		},
		cursor: {
