...
function createShimElectronAPI() {
	return {
		...
		showHudNativeInputMenu: () => Promise.resolve(null),
		showHudNativeSettingsMenu: () => Promise.resolve(null),
		openAreaSelector: () => Promise.resolve(null),
		confirmAreaSelection: () => undefined,
		cancelAreaSelection: () => undefined,
		startNewRecording: () => Promise.resolve({ success: true }),
		openSourceSelector: (_preferredSourceKind?: "screen" | "window") =>
