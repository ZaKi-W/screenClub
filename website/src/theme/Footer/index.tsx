...
/**
 * Custom footer matching "ScreenClub Docs Site.dc.html" 1:1 — a 1.4fr/1fr/1fr
		...
		<footer className={styles.footer}>
			<div className={styles.inner}>
				<div className={styles.columns}>
					<div>
						<div className={styles.brand}>
							...
							<span className={styles.brandName}>ScreenClub</span>
						</div>
				...
				<div className={styles.bottomBar}>
					<p>
						ScreenClub is released under the MIT license. Built by the community — free, forever.
					</p>
